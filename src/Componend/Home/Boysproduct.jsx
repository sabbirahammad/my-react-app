...
const ProductShowcase = () => {
  ...
  if (!products || products.length === 0) {
    return (
      <div className="bg-black min-h-screen py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
  ...
  return (
    <div className="bg-black min-h-screen py-12 px-4 sm:px-6 lg:px-8 -mt-[130px]">
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-9 gap-4 sm:gap-6">
          {/* Left Small Cards (2x2 Grid) */}
          <div
            className="col-span-1 sm:col-span-2 lg:col-span-3 grid grid-cols-2 gap-4 rounded-lg p-2"
            style={{
              background:
